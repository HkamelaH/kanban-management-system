...
namespace IntroSE.Kanban.Backend.DataAccessLayer.DAL
{
    ...
    /// <summary>
    /// converts SQLiteReader to the corresponding DAO object so we can handle it and deal with it!
    /// </summary>
    /// <param name="reader"></param>
    /// <returns></returns>
    protected abstract DAOs ConvertReaderToObject(SQLiteDataReader reader);
