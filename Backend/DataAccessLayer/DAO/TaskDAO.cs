...
namespace IntroSE.Kanban.Backend.DataAccessLayer.DAO
{
    public class TaskDAO : DAOs
    {
        ...
        public TaskDAO(int taskID, DateTime CreateTime, DateTime DueDate, string title, string description, string Email, int BoardId, int Ordinal) : base(new DALtaskcontroller())
        {
            this.TaskId = taskID;
